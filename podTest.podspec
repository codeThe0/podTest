...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/codeThe0/podTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'codeThe0' => 'luke99chen@hotmail.com' }
  s.source           = { :git => 'https://github.com/codeThe0/podTest.git', :tag => s.version.to_s }
